    ...
    <section className="container mx-auto grid gap-8 px-4 py-12 md:grid-cols-2 md:py-16">
      <div className="flex flex-col justify-center">
        ...
        <p className="mt-4 text-pretty text-muted-foreground md:text-lg">
          Ketika rasa ingin tahu bertemu dengan kolaborasi. Mulai jelajahi ide, berdiskusi, dan wujudkan inovasi bersama
          dalam atmosfer yang estetik, intuitif, dan inspiratif.
        </p>
      ...
      <div className="relative">
        <img
          src={"/placeholder.svg?height=480&width=720&query=kolaborasi%20anak%20muda%20berdiskusi"}
