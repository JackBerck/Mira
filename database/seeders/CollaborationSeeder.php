    ...
    public function run(): void
    {
        $collaborations = [
            [
                ...
                'status' => 'open',
                'image' => 'collaboration_images/aplikasi_pendidikan.png',
                'forum_category_id' => 1,
                'user_id' => 1,
            ],
            [
                ...
                'status' => 'open',
                'image' => 'collaboration_images/penanaman_pohon.png',
                'forum_category_id' => 4,
                'user_id' => 2,
            ],
            [
                ...
                'status' => 'open',
                'image' => 'collaboration_images/kesehatan_mental.png',
                'forum_category_id' => 5,
                'user_id' => 3,
            ],
            [
                ...
                'status' => 'open',
                'image' => 'collaboration_images/gerakan_mengurangi_sampah_plastik.png',
                'forum_category_id' => 4,
                'user_id' => 4,
            ],
            [
                ...
                'status' => 'open',
                'image' => 'collaboration_images/platform_ecommerce_lokal.png',
                'forum_category_id' => 6,
                'user_id' => 1,
            ],
        ];
