    ...
    public function run(): void
    {
        $forums = [
            [
                ...
                'image' => 'forum_images/gerakan_mengurangi_sampah_plastik.png',
                'forum_category_id' => 1,
                'user_id' => 1,
            ],
            [
                ...
                'image' => 'forum_images/edukasi_daerah_terpencil.png',
                'forum_category_id' => 2,
                'user_id' => 2,
            ],
            [
                ...
                'image' => 'forum_images/aksi_melawan_hoaks.png',
                'forum_category_id' => 3,
                'user_id' => 3,
            ],
            [
                ...
                'image' => 'forum_images/urban_farming.png',
                'forum_category_id' => 4,
                'user_id' => 4,
            ],
            [
                ...
                'image' => 'forum_images/aplikasi_kesehatan_mental.png',
                'forum_category_id' => 5,
                'user_id' => 1,
            ],
        ];
